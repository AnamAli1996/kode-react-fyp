...
const NavBarDropdown = props => {
    let { toggleClassName, style, disabled, text, children, ignoreContentClick = false, keepOpenIfItemClickedNoLongerInDocument, ...rest } = props;

    return (
        <ButtonDropdown containerElementType="li" clean={true} ignoreContentClick={ignoreContentClick} keepOpenIfItemClickedNoLongerInDocument={keepOpenIfItemClickedNoLongerInDocument} className={`dropdown ${!!disabled ? 'disabled' : ''}`} disabled={!!disabled}>
