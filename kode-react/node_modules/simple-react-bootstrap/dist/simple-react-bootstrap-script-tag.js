...
var ButtonDropdown = function (_Component) {
    ...
    function ButtonDropdown() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ButtonDropdown.__proto__ || Object.getPrototypeOf(ButtonDropdown)).call.apply(_ref, [this].concat(args))), _this), _this.state = { open: false }, _this.documentClick = function (evt) {
            ...
            if (_this.toggleBtn) {
                if (_this.toggleBtn instanceof React.Component) {
                    toggleBtnDomNode = reactDom.findDOMNode(_this.toggleBtn);
                } else {
            ...
            if (isOpen) {
                if (_this.props.ignoreContentClick) {
                    ...
                    if (_this.contentMenu) {
                        if (_this.contentMenu instanceof React.Component) {
                            contentMenuNode = reactDom.findDOMNode(_this.contentMenu);
                        } else {
    ...
    createClass(ButtonDropdown, [{
        ...
        value: function render$$1() {
            ...
            if (toggleUnadjusted) {
                ...
                toggle = React__default.cloneElement(toggleUnadjusted, {
            ...
            if (contentUnadjusted) {
                content = React__default.cloneElement(contentUnadjusted, {
            ...
            //simple case
            if (children.length === 2) {
                return React.createElement(containerElementType, _extends({ className: classToAdd }, rest), React__default.cloneElement(toggle, { disabled: disabled }), !this.props.deferDropdownRendering || isOpen ? content : null);
            } else {
                ...
                return React.createElement.apply(undefined, [containerElementType, _extends({ className: classToAdd }, rest)].concat(toConsumableArray(childrenToUse)));
            }
        }
    }]);
    ...
    createClass(Modal, [{
        ...
        value: function renderModal(cb) {
            ...
            reactDom.render(React__default.createElement(
                ...
                manual ? children : React__default.createElement(
                    'div',
        ...
        value: function componentWillUnmount() {
            ...
            setTimeout(function () {
                reactDom.unmountComponentAtNode(_this3.__div);
                setTimeout(function () {
...
var NavBarBrand = function NavBarBrand(props) {
    return React__default.cloneElement(props.children, { className: 'navbar-brand', key: 'nav-bar-brand' });
};
        ...
        value: function render$$1() {
            ...
            return React__default.createElement(
                ...
                React__default.Children.map(children, function (child) {
                    return child.type === NavBarToggle ? React__default.cloneElement(child, { onClick: onClick, key: 'nav-bar-toggle' }) : child;
                })
            );
        }
    }]);
...
var NavBarItemDivider = function NavBarItemDivider(props) {
    return React__default.createElement('li', { role: 'separator', className: 'divider' });
};
...
var NavBarDropdown = function NavBarDropdown(props) {
    var toggleClassName = props.toggleClassName,
        ...
        keepOpenIfItemClickedNoLongerInDocument = props.keepOpenIfItemClickedNoLongerInDocument,
        rest = objectWithoutProperties(props, ['toggleClassName', 'style', 'disabled', 'text', 'children', 'ignoreContentClick', 'keepOpenIfItemClickedNoLongerInDocument']);


    return React__default.createElement(
        ButtonDropdown,
        { containerElementType: 'li', clean: true, ignoreContentClick: ignoreContentClick, keepOpenIfItemClickedNoLongerInDocument: keepOpenIfItemClickedNoLongerInDocument, className: 'dropdown ' + (!!disabled ? 'disabled' : ''), disabled: !!disabled },
        React__default.createElement(
            'a',
...
var NavBar = function (_React$Component2) {
    ...
    createClass(NavBar, [{
        ...
        value: function render$$1() {
            ...
            if (header) {
                header = React__default.cloneElement(header, { onClick: this.toggleMobileCollapse.bind(this), ref: function ref(el) {
            ...
            var TabLink = function (_Component2) {
                ...
                _createClass(TabLink, [{
                    ...
                    value: function render$$1() {
                        ...
                        return React__default.createElement('a', { href: href || '#' + tab, onClick: this.onClick }, children);
                    }
                }]);
            ...
            var TabHeader = function (_Component3) {
                ...
                _createClass(TabHeader, [{
                    ...
                    value: function render$$1() {
                        ...
                        return render$$1 ? render$$1(propsToPass) : React.cloneElement(React.Children.only(child), propsToPass);
                    }
                }]);
            ...
            var TabPane = function (_Component4) {
                ...
                _createClass(TabPane, [{
                    ...
                    value: function render$$1() {
                        ...
                        return self.currentTab == this.props.tab || this.props.renderInActiveTabs ? render$$1 ? render$$1({ isActive: self.currentTab == this.props.tab }) : React.cloneElement(React.Children.only(child), propsToPass) : null;
                    }
                }]);
...
var Tabs = function (_Component2) {
    ...
    function Tabs(props) {
        ...
        var firstTab = React.Children.toArray(_this2.props.children)[0],
                    ...
                    return React__default.createElement(
                        ...
                        React__default.createElement(
                            ...
                            tabs.map(function (tab, i) {
                                ...
                                return React__default.createElement(TabHeader, _extends({}, rest, { key: id, tab: id, render: function render$$1(_ref2) {
                        ...
                        React__default.createElement(
                            ...
                            tabs.map(function (tab, i) {
                                ...
                                return React__default.createElement(TabPane, { key: id, tab: id, render: function render$$1(_ref3) {
...
}((this.SimpleReactBootstrap = this.SimpleReactBootstrap || {}),React,ReactDOM));
